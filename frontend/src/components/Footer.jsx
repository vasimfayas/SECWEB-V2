        ...
        <div className="md:col-span-5">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 border border-[#D4AF37] flex items-center justify-center">
              <span className="font-heading font-black text-[#D4AF37]">SE</span>
            </div>
            <div className="leading-none">
              <div className="font-heading font-bold text-white text-xl">SHANNON</div>
              <div className="text-[11px] tracking-[0.3em] text-[#D4AF37] font-semibold">ENGINEERING</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 mt-8">
            {[Linkedin, Twitter, Instagram].map((Icon, i) => (
              <a
                key={i}
                href="#"
                className="w-10 h-10 border border-white/15 flex items-center justify-center text-white/70 hover:text-[#D4AF37] hover:border-[#D4AF37] transition-all"
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={l.to}>
                <Link
                  to={l.to}
                  className="text-white/75 hover:text-[#D4AF37] transition-colors inline-flex items-center gap-1 font-body"
        ...
        <div className="md:col-span-4">
          ...
          <ul className="space-y-4 text-white/75">
            ...
            <li className="flex items-center gap-3">
              ...
              <a href="mailto:hello@shannoneng.com" className="hover:text-[#D4AF37] transition-colors">hello@shannoneng.com</a>
            </li>
            <li className="flex items-center gap-3">
              <Phone className="w-4 h-4 text-[#D4AF37] flex-shrink-0" />
              <a href="tel:+442071234567" className="hover:text-[#D4AF37] transition-colors">+44 20 7123 4567</a>
            </li>
          </ul>
          <Link
            to="/contact"
            className="inline-flex items-center gap-2 mt-8 text-[#D4AF37] font-heading uppercase text-xs tracking-[0.2em] hover:gap-3 transition-all"
