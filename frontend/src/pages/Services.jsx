...
export default function Services() {
  return (
    <div data-testid="services-page" className="bg-[#050A1F]">
      {/* Header */}
      <section className="pt-40 pb-20 blueprint-bg">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <motion.p
            ...
            className="mt-8 text-white/70 max-w-2xl text-lg leading-relaxed"
          >
            ...
            {services.map((s, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="service-card group bg-[#050A1F] p-10 lg:p-12 border border-transparent cursor-default min-h-[340px]"
                ...
                >
                  ...
                  <div className="service-detail">
                    <p className="text-white/75 text-sm leading-relaxed border-t border-white/10 pt-4">{s.detail}</p>
                  </div>
                </motion.div>
              );
            })}
      ...
      <section className="py-24 lg:py-32 bg-[#0A1128]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7 space-y-px bg-white/5">
            {[
